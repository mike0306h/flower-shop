...
class User(Base):
    ...
    line_notifications = Column(Boolean, default=False)
    # 头像
...
class DeliveryPerson(Base):
    ...
    phone = Column(String(20))
    avatar = Column(String(255))  # emoji or image URL
    status = Column(String(20), default="available")  # available / busy / off
    created_at = Column(DateTime, server_default=func.now())
